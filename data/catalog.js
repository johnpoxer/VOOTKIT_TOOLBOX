...
(function (root, factory) {
  ...
  var TOOLS = [
    ...
    t("crypto-profit","finance","Crypto Profit & DCA","Profit, loss and dollar-cost-average entry across buys.",{tier:"money",kw:"bitcoin average cost gain"}),
    ...
    t("percentage-calculator","finance","Percentage Calculator","Percent of, is-what-percent, and percentage change.",{tier:"retention",kw:"percent increase decrease"}),
    t("tip-split","finance","Tip & Bill Split","Split a bill with tip across any number of people.",{tier:"retention",kw:"restaurant gratuity"}),

    /* ---------- MONEY: insurance (CPC $31.40 — highest on the internet) ---------- */
    t("life-insurance-needs","insurance","Life Cover Estimator","Estimate the life cover a household would actually need.",{tier:"money",kw:"life insurance how much coverage"}),
    t("auto-insurance-estimator","insurance","Auto Cover Estimator","Work out sensible liability and deductible levels.",{tier:"money",kw:"car insurance coverage deductible"}),
    t("deductible-calculator","insurance","Deductible Trade-off","Compare premium savings against out-of-pocket risk.",{tier:"money",kw:"excess premium"}),
    ...
    t("paycheck-calculator","tax","Take-Home Pay","Estimate net pay from gross salary.",{tier:"money",kw:"net salary after tax paycheck"}),
    t("income-tax-estimator","tax","Income Tax Estimator","Rough tax due or refund on a year's income.",{tier:"money",kw:"tax refund return"}),
    t("self-employment-tax","tax","Self-Employment Tax","Estimate tax and national insurance for the self-employed.",{tier:"money",kw:"freelance tax sole trader"}),
    t("overtime-calculator","tax","Overtime Pay","Overtime and premium hours at any multiplier.",{tier:"money",kw:"time and a half"}),
    t("pto-accrual","tax","PTO Accrual","Holiday accrued to date from your entitlement.",{tier:"money",kw:"annual leave vacation days"}),
    t("employee-cost","tax","True Employee Cost","Salary plus benefits, taxes, equipment and overhead.",{tier:"money",kw:"cost of hiring burden rate"}),
    ...
    t("hourly-rate","business","Hourly Rate Calculator","The rate you must charge to hit your income target.",{tier:"money",kw:"freelance day rate pricing"}),
    t("profit-margin","business","Profit Margin","Margin, markup and selling price from cost.",{tier:"money",kw:"markup gross margin"}),
    t("break-even","business","Break-Even Point","Units and revenue needed to cover fixed costs.",{tier:"money",kw:"fixed variable cost"}),
    t("late-fee","business","Late Fee Calculator","Interest and fees on an overdue invoice.",{tier:"money",kw:"overdue payment interest"}),
    t("vat-gst","business","VAT / GST Calculator","Add or remove sales tax from any price.",{tier:"traffic",kw:"sales tax inclusive"}),
    ...
    t("delete-pdf-pages","pdf","Delete PDF Pages","Remove pages you don't need and re-save.",{tier:"traffic",kw:"remove page"}),
    t("reorder-pdf","pdf","Organise PDF Pages","Drag pages into a new order.",{tier:"traffic",kw:"rearrange sort pages"}),
    ...
    t("pdf-page-numbers","pdf","Add Page Numbers","Stamp page numbers in any corner.",{tier:"traffic",kw:"numbering footer"}),
    t("pdf-watermark","pdf","PDF Watermark","Stamp text across pages to mark a draft or copy.",{tier:"traffic",kw:"draft confidential stamp"}),
    t("protect-pdf","pdf","Protect PDF","Add a password to a document before sharing it.",{tier:"traffic",kw:"encrypt password lock"}),
    ...
    t("heic-converter","images","HEIC Converter","Turn iPhone HEIC photos into JPG or PNG.",{tier:"traffic",kw:"iphone photo heif"}),
    t("crop-image","images","Crop Image","Crop to a ratio or exact selection.",{tier:"traffic",kw:"cut trim"}),
    t("bulk-resize","images","Bulk Image Resizer","Resize a batch of images in one pass.",{tier:"traffic",kw:"multiple batch"}),
    t("favicon-generator","images","Favicon Generator","Every favicon size and the HTML to go with it.",{tier:"gap",kw:"ico site icon"}),
