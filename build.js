...
<article class="founder-story">
  ...
  <div class="founder-story-body">
    ...
    <section class="founder-facts"><h2>Founder information</h2><dl><div><dt>Name</dt><dd>John Prosper</dd></div><div><dt>Role</dt><dd>Founder and Full Stack Developer</dd></div><div><dt>Responsibilities</dt><dd>Product development, engineering, performance, accessibility, technical SEO and user experience</dd></div><div><dt>Project source</dt><dd><a href="https://github.com/johnpoxer/VOOTKIT_TOOLBOX" rel="me noopener" target="_blank">View the Vootkit repository on GitHub</a></dd></div><div><dt>Contact</dt><dd><a href="contact.html">Contact Vootkit</a></dd></div></dl></section>
