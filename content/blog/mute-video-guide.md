...
date: "2026-08-28"
description: "Strips the audio track and copies the video through untouched. The exact command is -c copy -an: no decoding, no re-encoding, no quality loss whatsoever.…"
...
Open the [Mute / Strip Audio](/tools/video/mute-video/) and follow the settings and checks below.
