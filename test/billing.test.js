...
(async function () {
  ...
  ok(billing.PAID_PLANS.has("creator_pro") && billing.PAID_PLANS.size === 1, "Creator Pro is the only paid plan");
  ...
  ok(!/Creator Teams|creator_teams|data-price="teams"/.test(pricing), "pricing contains no Teams plan or checkout controls");
